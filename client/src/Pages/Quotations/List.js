      ...
      .then((result) => {
        if (result.data.status === "SUCCESS") {
          const fetchedQuotations = result.data.quotations.map((element) => ({
            ...
            quotation_date: dayjs(new Date(element.quotation_date)).format('DD-MMM-YYYY'),
            ...
            discount: parseFloat(element.discount)===0 ? element.discount : '-'+element.discount,
